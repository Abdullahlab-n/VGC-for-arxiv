// === VGC 2.5 PPE Matrix Benchmark (Single-Core, 256x256 Matrix Multiply) ===     //
// Compiler:                                                                      //
// g++ -O3 -march=native -std=c++17 ppe_matrix_256.cpp -lpsapi -o matrix256.exe  //
...
int main() {
    ...
    std::cout << "=== VGC 2.5 PPE Matrix Benchmark (Single-Core, 256x256) ===\n";
